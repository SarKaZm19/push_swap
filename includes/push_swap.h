...
//apply_rotations.c
int		ft_apply_rarb(t_pile *a, t_pile *b, int nbr, char stack);
int		ft_apply_rrarrb(t_pile *a, t_pile *b, int nbr, char stack);
int		ft_apply_rarrb(t_pile *a, t_pile *b, int nbr, char stack);
int		ft_apply_rrarb(t_pile *a, t_pile *b, int nbr, char stack);
